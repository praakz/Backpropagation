...
#synapses
syn0 = 2*np.random.random((inputBuffer,hiddenNeurons)) - 1  # 3x4 matrix of weights ((2 inputs + 1 bias) x 4 nodes in the hidden layer)
syn1 = 2*np.random.random((hiddenNeurons,hiddenNeurons)) - 1  # 4x1 matrix of weights. (4 nodes x 1 output) - no bias term in the hidden layer.
syn2 = 2*np.random.random((hiddenNeurons,outputNeurons)) - 1  # 4x1 matrix of weights. (4 nodes x 1 output) - no bias term in the hidden layer.
